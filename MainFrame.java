...
public class MainFrame extends JFrame {
    ...
    // ── Tab 1: View all transactions in a table ──────────────────────────────
    private JPanel buildTransactionsPanel() {
        ...
        // Delete and Edit buttons at the bottom
    ...
    private JPanel buildAddPanel() {
        ...
        panel.add(new JLabel("Category: (food, entertainment etc)"), gbc);
        gbc.gridx = 1;
        ...
        addBtn.addActionListener(e -> {
            ...
            try {
                ...
                manager.addTransaction(type, category, amount, desc);

                // Refresh the transactions table
                tableModel.addRow(new Object[]{
                    manager.getTransactions().get(manager.getTransactions().size() - 1).getId(),
                    type, category, amount, desc
                });
